...
#                                                                                                                     #
#
#                 This project summary is from the perspective of a data scientist working for an                     #             
#                 “Internet of Things” analytics consulting firm whose client is a home developer.                    #              
#                 The client would like to know if insights can be found in the sub-metered energy consumption        #    
#                 data set that could be used as an incentive to potential home buyers that may be interested in      #            
#                “smart home” technology.                                                                                  
#                 The main business objective of the project is to Determine if the installation of sub-metering      #             
#                 devices that  measure power consumption can translate into economic incentive recommendations for   #        
#                 homeowners.                                                                                         #                                                                                                                                                                                        #
#                                                                                                                     #
#                 The data contains 2,075,259 measurements of electric power consumption in one household located in  #
#                 France with a one-minute sampling rate for the period Dec.2006 to Nov. 2010                         #
#                                                                                                                     #
#                 Version 1.0                                                                                         #
#                                                                                                                     #
...
#3Subset data by quarter and summarise total usage across the 3 submeters
